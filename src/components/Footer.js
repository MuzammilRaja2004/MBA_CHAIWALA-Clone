    ...
    <>
      <footer>
        ...
        <aside onMouseLeave={linksBackToNormal}>
            ...
            <a href="/event" className="footerLinks" onMouseOver={() => footerLinks(4)} data-cursorpointermini={true}>Events</a>
        ...
        <div>
            <h5>Phone</h5>
            <a href="tel:+923144489654">923144489654</a>
        </div>
        <p>© COPYRIGHT 2022 MBA CHAIWALA. MADE BY MUZAMMIL RAJA</p>
      </footer>
